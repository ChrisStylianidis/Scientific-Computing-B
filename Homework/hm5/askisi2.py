...
print(more.brute())
print(more.newton(gtonos))
print(more.secant())
print(more.bisection())

print("\nf(x)=x^2-5x+6          xe[0,12]")
sqr17=solutions(sq,0,12,1e-14)
print(sqr17.brute())
print(sqr17.newton(sqtonos))
print(sqr17.secant())
...
opws to trito paradigma, kathos ta komatia pou pernei den einai panw kai katw
apo tin y=0 ara den vlepei tin allagi tou prosimou i sinartisi
